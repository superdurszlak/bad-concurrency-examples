...
open class ShowAmdahlLawScenario: BaseMatrixCopyingScenario() {
    ...
    open class ExecutionPlan(
        ...
        override var copyingAlgorithm: CopyingAlgorithm = CopyingAlgorithm.CONCURRENT_COPY,
        @Param("THREAD_POOL_EXECUTOR")
        override var taskExecutorFactory: TaskExecutorFactory = TaskExecutorFactory.THREAD_POOL_EXECUTOR,
        @Param("show influence of concurrency on copying speed")
